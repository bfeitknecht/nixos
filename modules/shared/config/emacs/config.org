...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Basil Feitknecht"
    user-mail-address "bfeitknecht@ethz.ch")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/bf/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/bf/bin" "/profile/bin" "/Users/bf/.npm-packages/bin" "/Users/bf/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
